...
**Architecture:** A new `api/` package with `main.py` (routes + CORS), `schemas.py` (Pydantic), `services.py` (thin adapters over existing modules). FastAPI's `TestClient` drives endpoint tests under `tests/api/`. Single `uvicorn api.main:app` entrypoint runs in a Python 3.11 Docker container deployable to Fly.io / Render / Railway.
...
| `tests/api/__init__.py` (create) | Empty package marker. |
| `tests/api/test_endpoints.py` (create) | FastAPI `TestClient`-based tests for all 5 endpoints. |
...
- Create: `api/__init__.py`, `api/main.py`, `tests/api/__init__.py`, `tests/api/test_endpoints.py`
...
Create `tests/api/__init__.py` as an empty file (zero bytes).

- [ ] **Step 4: Write the failing healthz test**

Create `tests/api/test_endpoints.py` with:
...
Run: `cd /Users/manishadhikari/Documents/Projects/daysoff-api && python3 -m unittest tests.api.test_endpoints -v 2>&1 | tail -5`
...
Expected: `OK` with test count of 112 (111 baseline + 1 new).

- [ ] **Step 9: Commit**

```bash
cd /Users/manishadhikari/Documents/Projects/daysoff-api
git add requirements.txt api/__init__.py api/main.py tests/api/__init__.py tests/api/test_endpoints.py
...
- Modify: `api/main.py`, `tests/api/test_endpoints.py`

- [ ] **Step 1: Write the failing tests**

Append to `tests/api/test_endpoints.py`, before the `if __name__ == "__main__":` line:
...
Run: `cd /Users/manishadhikari/Documents/Projects/daysoff-api && python3 -m unittest tests.api.test_endpoints.TestCountries -v 2>&1 | tail -5`
...
Run: `cd /Users/manishadhikari/Documents/Projects/daysoff-api && python3 -m unittest tests.api.test_endpoints -v 2>&1 | tail -10`
...
```bash
cd /Users/manishadhikari/Documents/Projects/daysoff-api
git add api/schemas.py api/services.py api/main.py tests/api/test_endpoints.py
...
**Files:**
- Modify: `api/schemas.py`, `api/services.py`, `api/main.py`, `tests/api/test_endpoints.py`
...
Run: `cd /Users/manishadhikari/Documents/Projects/daysoff-api && python3 -m unittest tests.api.test_endpoints.TestHolidays -v 2>&1 | tail -10`
...
Run: `cd /Users/manishadhikari/Documents/Projects/daysoff-api && python3 -m unittest tests.api.test_endpoints -v 2>&1 | tail -15`
...
Run: `cd /Users/manishadhikari/Documents/Projects/daysoff-api && python3 -m unittest tests.api.test_endpoints.TestCompare -v 2>&1 | tail -10`
Expected: FAIL — endpoint returns 404 for all.
...
Run: `cd /Users/manishadhikari/Documents/Projects/daysoff-api && python3 -m unittest tests.api.test_endpoints.TestSandwiches -v 2>&1 | tail -10`
...
Run: `cd /Users/manishadhikari/Documents/Projects/daysoff-api && python3 -m unittest discover tests 2>&1 | tail -3`
Expected: `OK` — total count = 111 baseline + 2 (Task 2 news_source) + 2 (Task 6A sandwich) + 22 (api) = 137 (give or take 1–2).
